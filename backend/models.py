...
class UserProfile(Base):
    ...
    study_points: Mapped[int] = mapped_column(nullable=False, default=0, server_default="0")
    tutor_points: Mapped[int] = mapped_column(nullable=False, default=0, server_default="0")
    total_points: Mapped[int] = mapped_column(nullable=False, default=0, server_default="0")
    points_last_computed_at: Mapped[datetime | None] = mapped_column(DateTime(timezone=True), nullable=True)
